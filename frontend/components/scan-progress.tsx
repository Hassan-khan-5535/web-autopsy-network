...
const LABELS: Record<string, string> = {
  ...
  risk: "Risk & heuristic prioritization",
  recon: "Recon Agent",
...
const PHASES = [
  ...
  { key: "ANALYZING", label: "Analyzing", description: "HTTP behavior, API, vulnerability, secrets, CVE intelligence, evidence quality, correlation graph, risk prioritization, recon, technology, structure, security, performance, accessibility, and content" },
